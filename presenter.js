        ...
        const notes = {
            ...
            '8': {
                ...
                content: `
                    ...
                    <p>At the top, you see our overall performance: <strong>84% accuracy</strong>—meaning out of 100 detections, 84 are correct. <strong>88% coverage</strong>—we find 88 out of every 100 PII items that exist. And most importantly, <strong>2 PII types achieve perfect 100% detection</strong>.</p>
                    ...
                    <p><strong>SSN:</strong> 100%—all social security numbers found correctly. <strong>Perfect</strong>.</p>
                    <p>These two types have very consistent formats, so regex works perfectly. This validates our core hypothesis: <em>regex-based detection is optimal for structured PII</em>.</p>
                    <p>For <strong>addresses</strong>, you see a blue bar at 92%. This is excellent—addresses follow predictable patterns, but some variations exist that we don't catch. Still, 92% is very strong.</p>
                    ...
                    <div class="key-points">
                        <strong>Key message:</strong> "Two types are perfect, one type is excellent (92%), and two types are good. Overall, we're 84% accurate and catch 88% of all PII."
                    </div>
            ...
            '9': {
                ...
                content: `
                    ...
                    <p><strong>Address detection:</strong> This is the most dramatic. Baseline finds zero addresses—red bar is empty, 0%. Our system finds 92 out of 100 addresses—blue bar at 92%. This is a <strong>new capability</strong>—baseline couldn't do this at all. Some address variations exist that we don't catch, but 92% is excellent.</p>
            ...
            '12': {
                ...
                content: `
                    ...
                    <p>Here's the interface. Users can paste a Pastebin or Google Docs URL, or click the example buttons. Let me use the Pastebin example: pastebin.com/3EqkjVmB.</p>
                    <p>[<em>Click Pastebin Example button or paste URL, click Analyze - 10s</em>]</p>
                    <p>[<em>Wait for results - 5s</em>]</p>
                    <p>Here are the results in real-time. You can see the risk level assessment—this shows MEDIUM risk. Below, PII breakdown by type shows we detected multiple emails, phone numbers, names, addresses, and even SSN. At bottom, security recommendations tailored to what was found.</p>
                    ...
                    <p>You can also try the Google Docs example to see how it handles different platforms. The code for both demo and evaluation is open source on GitHub."</p>
                    <div class="key-points">
                        <strong>Example URLs ready:</strong><br>
                        • Pastebin: pastebin.com/3EqkjVmB<br>
                        • Google Docs: docs.google.com/document/d/1Y1ai_O5xowwG_x-mKaN7HvG-i1-U1h0b2IfmPHANLy4/edit
                    </div>
